...
\begin{frame}
    ...
    \begin{figure}[!ht]
        \centering
        \includegraphics[trim=2cm 0.5cm 2cm 0.5cm, clip, width=0.40\textwidth]{meshes/uniform/square_1000.pdf}
        \includegraphics[trim=2cm 0.5cm 2cm 0.5cm, clip, width=0.40\textwidth]{meshes/uniform/lshape_1000.pdf}
