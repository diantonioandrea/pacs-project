...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=6cm]{meshes/adaptive/square_h_5.pdf}
	\includegraphics[width=6cm]{meshes/adaptive/square_h_10.pdf}
	\includegraphics[width=6cm]{meshes/adaptive/square_h_20.pdf}
	\caption{Square mesh after 5, 10 and 20 refinements, $N_0 = 125$.}
\end{figure}

\begin{figure}[!ht]
	\centering
	\includegraphics[width=6cm]{meshes/adaptive/lshape_h_5.pdf}
	\includegraphics[width=6cm]{meshes/adaptive/lshape_h_10.pdf}
	\includegraphics[width=6cm]{meshes/adaptive/lshape_h_20.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=6cm]{meshes/adaptive/square_gh_5.pdf}
	\includegraphics[width=6cm]{meshes/adaptive/square_gh_10.pdf}
	\includegraphics[width=6cm]{meshes/adaptive/square_gh_20.pdf}
	\caption{Square mesh after 5, 10 and 20 refinements, $N_0 = 125$.}
\end{figure}

\begin{figure}[!ht]
	\centering
	\includegraphics[width=6cm]{meshes/adaptive/lshape_gh_5.pdf}
	\includegraphics[width=6cm]{meshes/adaptive/lshape_gh_10.pdf}
	\includegraphics[width=6cm]{meshes/adaptive/lshape_gh_20.pdf}
	\caption{L-shaped mesh after 5, 10 and 20 refinements, $N_0 = 125$.}
\end{figure}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=6cm]{meshes/adaptive/square_eh_5.pdf}
	\includegraphics[width=6cm]{meshes/adaptive/square_eh_10.pdf}
	\includegraphics[width=6cm]{meshes/adaptive/square_eh_20.pdf}
	\caption{Square mesh after 5, 10 and 20 refinements, $N_0 = 125$.}
\end{figure}

\begin{figure}[!ht]
	\centering
	\includegraphics[width=6cm]{meshes/adaptive/lshape_eh_5.pdf}
	\includegraphics[width=6cm]{meshes/adaptive/lshape_eh_10.pdf}
	\includegraphics[width=6cm]{meshes/adaptive/lshape_eh_20.pdf}
	\caption{L-shaped mesh after 5, 10 and 20 refinements, $N_0 = 125$.}
\end{figure}
