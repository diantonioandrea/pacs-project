...
Refinement occurs by setting a refinement percentage and marking all elements where the local error exceeds that percentage of the highest error. Let $\gamma$ be this percentage, the elements $K$ to be refined are those such that:
...
Error trends and refined meshes are presented in the following sections. For all examples shown, $\gamma = 75\%$.
