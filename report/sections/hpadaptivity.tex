...
This method, given the approximation phase for the decay rate of the Legendre coefficients, works best when starting with a high polynomial order such as $k = 3$.
