...
In the expressions above, $\llbracket \cdot \rrbracket$ and $\{\!\!\{\cdot\}\!\!\}$ denote the jump and average operators, respectively, which are used to handle the discontinuities across element boundaries.
