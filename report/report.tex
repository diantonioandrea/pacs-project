...
\begin{document}
	...
	\begin{abstract}
		\begin{center}
			Report for the course \textit{Advanced Programming for Scientific Computing} on the implementation details\footnote{Technical details available on \hyperlink{https://github.com/diantonioandrea/pacs-project}{GitHub}.} of an adaptive HP discontinuous Galërkin algorithm.
		\end{center}
	\end{abstract}
